...
router.post("/api/reactions", function(req, res) {
    const query = `INSERT INTO reactions
        ...
        VALUES (${req.body.reactionTime}, ${req.body.username}, ${req.body.symp_ItchySkin}, 
            ...
            ${req.body.symp_DifficultBreathing}, ${req.body.symp_LossOfConsciousness}, ${req.body.severity}, 
